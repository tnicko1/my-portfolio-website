...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  useEffect(() => {
    ...
    const cleanupTarget = (target: Element) => {
      ...
      if (originalTargetCursor !== null) {
        (target as HTMLElement).style.cursor = originalTargetCursor;
        originalTargetCursor = null;
      }
    ...
    let originalTargetCursor: string | null = null;
    ...
    const enterHandler = (e: MouseEvent) => {
      ...
      activeTarget = target;
      originalTargetCursor = (target as HTMLElement).style.cursor;
